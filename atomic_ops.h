...
static inline void btatas_acquire_slowpath(tatas_lock_t* L)
{
    int b = 64;
...
static inline void btatas_acquire(tatas_lock_t* L)
{
    if (tas(L))
        btatas_acquire_slowpath(L);
}

static inline void btatas_release(tatas_lock_t* L)
{
*L = 0;
}
